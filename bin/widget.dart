  ...
  String toString() {
    ...
    String code = 'import \'dart:async\';\n'
        ...
        'FormBloc.widgetFormState == BlocFormState.display);\n'
            ...
            '                            context,\n'
            '                            MaterialPageRoute(\n'
            '                                builder: (context) => '+modelName+'WidgetEdit()));\n'
        '                      },\n'
        '                    ));\n'
        '                    actionMenu.add(IconButton(\n'
        '                      icon: Icon(\n'
        ...
        '                            context,\n'
        '                            MaterialPageRoute(\n'
        '                                builder: (context) => '+modelName+'FormWidget()));\n'
        '                      },\n'
        '                    ));\n'
        '\n'
            '                    // actionMenu.add(IconButton(\n'
        ...
        'FormBloc.fields.map(((e) => e.builder!)),\n'
            ...
            '\n'
            '  void submit() {\n'
            '    '+modelName+'FormBloc.of(context).submit();\n'
            '    MainState.of(context).actionMenuRebuild([]);\n'
            '    MainState.of(context).notifyListeners();\n'
            ...
            'class '+modelName+'FormWidget extends StatefulPage {\n'
